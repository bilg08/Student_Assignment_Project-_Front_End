    ...
    <div className="px-5 py-4 bg-white w-[400px] h-[250px] shadow-2xl rounded-lg max-w-lg">
      <div className="flex mb-4">
        <img
          ...
          src={
            ad.owner &&
            `https://backend-leap2-production.up.railway.app/users/getUserProfilePhoto/${ad.owner.photo}`
            // https://backend-leap2-production.up.railway.app/getUserProfilePhoto/${ad.owner.photo}
          }
        />
